...
export default function Index() {
  ...
  useEffect(() => {
    ...
    return () => {
      habitSubscription(); //  to cancel the subscription
  ...
  const fetchTodaysCompletions = async () => {
    try {
      ...
      const complations = response.documents as unknown as HabitCompletion[]
      setCompletedHabits(complations.map((c) => c.habit_id));
    } catch (error) {
      console.error(error);
    }
  }
  ...
  const handleCompleteHabit = async (id: string) => {
    // if user is not signed in and habit is already completed for today.
            ...
            habits?.map((habit, key) => (
              <Swipeable
                ...
                onSwipeableOpen={(direction) => {
                  ...
                  // mandatory in case of deletion cuz items restructured, and need to remove deleted item form the ref.
                  // Also need to moved the item to the initial state.
                  ...
                  <View style={styles.cardContent}>
                    ...
                    <View style={styles.cardFooter}>
                      <View style={styles.streakBadge}>
                        ...
                        <Text style={styles.streakText}> {habit.streak_count} day straek</Text>
                      </View>
